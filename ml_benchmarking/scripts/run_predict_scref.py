...
from bascvi.datamodule import TileDBSomaIterDataModule, EmbDatamodule
...
for i, checkpoint_file in enumerate(checkpoint_files):
    ...
    ] = 7158  # TODO: this is hacky need to figure out how to handle pred mode for loading pretrained
    ...
    model = EmbeddingTrainer.load_from_checkpoint(
        checkpoint_file, datamodule=datamodule
    )
    ...
    embeddings_df.to_csv(
        os.path.join(run_root_dir, checkpoint_name, "pred_embeddings.tsv"), sep="\t"
    )
