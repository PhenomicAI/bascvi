...
embeddings = np.loadtxt('exp_logs/embeddings.csv',delimiter=',')
...
with open('exp_logs/file_list.list', 'rb') as handle:
...
embeddings_concat.to_csv('./exp_logs/embedded_cell_data.tsv',sep='\t')
