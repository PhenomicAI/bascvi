...
def log_zinb_positive(
    ...
    """
    Log likelihood (scalar) of a minibatch according to a zinb (Zero Inflated Negative Binomial) model.
...
def log_nb_positive(x: torch.Tensor, mu: torch.Tensor, theta: torch.Tensor, eps=1e-7):
    """
    Log likelihood (scalar) of a minibatch according to a nb (Negative Binomial) model.
...
def log_mixture_nb(
    ...
    """
    Log likelihood (scalar) of a minibatch according to a mixture nb (Negative Binomial) model.
...
class ZeroInflatedNegativeBinomial(NegativeBinomial):
    ...
    def log_prob(self, value: torch.Tensor) -> torch.Tensor:
        ...
        return log_zinb_positive(value, self.mu, self.theta, self.zi_logits, eps=1e-07)
